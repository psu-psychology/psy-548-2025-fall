...
%%| fig-cap: "Information flow from environment."
flowchart TD
...
%%| fig-cap: "Information flow from the infant to the environment."
flowchart TD
...
The cognitive task for the infant is to learn what prior perceptual states and what action(s) led to this fortuitous result.
...
Gilmore has been experimenting with them to help him see what is often hidden or glossed over, such as directional information flows like these.
