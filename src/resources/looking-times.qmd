...
The figures use the [`sequenceDiagram` type](https://docs.mermaidchart.com/mermaid-oss/syntax/sequenceDiagram.html) to reflect the structure of a simple looking time experiment.

The figures are relevant for work we did in class on Weeks [03](../schedule.qmd#week-03), [04](../schedule.qmd#week-04), and [05](../schedule.qmd#week-05).
