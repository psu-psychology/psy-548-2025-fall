...
:::
::: {.column width=60%}
![@OstranderUnknown-nr](https://www.genome.gov/sites/default/files/media/images/2022-05/Central-dogma.jpg)
:::
::::
...
:::
::: {.column width=40%}
![@UnknownUnknown-tz](../include/img/human-protein-atlas-table-01.png)
:::
::::

## Genes and the brain

![@UnknownUnknown-tz](../include/img/human-protein-atlast-table-02.png)
...
```{r}
#| label: fig-harshness-time-series
#| fig-cap: "Visualization of events that occur at different points in time with different magnitudes."
#| fig-align: center
#| 
t <- runif(10, min = 0, max = 25) |> 
  round(digits = 0) |>
  sort()
mag <- runif(length(t), min = 0, max = 2)
