...
$$x_2=l(sin(\theta_1)+1/2*sin(\theta_2))$$
$$y_2=-l(cos(\theta_1)+1/2*cos(\theta_2))$$
:::
::: {.column width=50%}
![@Wikipedia-contributors2025-oy](https://upload.wikimedia.org/wikipedia/commons/c/c9/Double-compound-pendulum-dimensioned.svg)
:::
::::
...
- Non-linearity
- Bifurcation points
  - Change in behavior with change in parameter
...
::: {.column width=40%}
- *On Growth and Form*
- @Thompson1917-ea; @Wikipedia-contributors2025-za
- Biological forms arise from physical and chemical laws
- Mathematical approach to biology
:::
::: {.column width=5%}
:::
::: {.column width=55%}
{{< video https://www.youtube.com/watch?v=saJWk8d2-lU&t=456s width="100%" height="70%">}}
...
## Approach [@Thelen2007-df pp. 289-292]

- Identify collective variable of interest
- Characterize behavioral attractor states
- Describe the dynamic trajectory of the collective variable
...
:::: {.columns}
::: {.column width=50%}
- How quantitative should (must? can?) we be? 
